...
if(isset($_POST['submit'])){
    $type=array('jpg','jpeg','png');//ClassType
    $mime=array('image/jpg','image/jpeg','image/png');
    $save_path='uploads'.date('/Y/m/d/');//According toWhenGenerateOneFileClip
    $upload=upload('uploadfile','512000',$type,$mime,$save_path);//UseFunction
    if($upload['return']){
        $html.="<p class='notice'>FileOnTransferSuccessful</p><p class='notice'>FileKeepStoreOfPathFor：{$upload['save_path']}</p>";
    }else{
    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <a href="#" style="float:right" data-container="body" data-toggle="popover" data-placement="bottom" title="tips(Click againOnceClose)"
               data-content="getimagesizeHasSolutionOnce">
                PointOnceTip~
            </a>
