...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            $html=<<<A
<div id="per_info">
   <h1 class="per_title">hello,{$name},WelcomeComeToPersonMemberIn | <a style="color:bule;" href="csrf_post.php?logout=1"></a></h1>
   ...
   <a class="edit" href="csrf_post_edit.php">ModifyPersonInformation</a>
</div>
A;
            echo $html;
            ?>
